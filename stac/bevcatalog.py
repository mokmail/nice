...
class Bevstac:
    def __init__(self):
        pass
    def create_stac_from_geotiff_url(self, geotiff_url: str, catalog_id: str = "my-geotiff-catalog", collection_id: str = "geotiff-collection", item_id: str = None, output_dir: str = "stac_catalog"):
        """
